...
int usernolik (){
    ...
    gameboard[4]='X';
    vyvod();
    send(Connection,"Print number from 1 to 9", 50,0);
    recv(Connection, msg1, sizeof(msg1),0);
    input = atoi(msg1);
//Определение количества поворотов
    if (input==2 || input==1){
        ...
        send(Connection,"Put in correct answer pls)...", 50,0);
    }
    ...
    if (input%2==0 ){
        ...
        if (gameboard[2]!='o'){
            gameboard[2] ='X';
            send(Connection,"You lose)", sizeof(gameboard),0);
            system ("pause");
        }
        else {
            gameboard[0] ='X';
            ...
            if (gameboard[2]=='o'){
                ...
                if (gameboard[7]!='o'){
                    ...
                    if (gameboard[3]!='o'){
                        ...
                        gameboard[6]='X';
                        vyvod();
                        send(Connection,"Lucky you)", sizeof(gameboard),0);
                        system ("pause");
                    }
                }
            }
